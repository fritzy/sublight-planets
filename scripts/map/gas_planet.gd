...
func _ready() -> void:
	...
	noise1.domain_warp_amplitude = 80.0
	noise1.domain_warp_frequency = 0.03
	noise1.domain_warp_fractal_octaves = 9.0
	noise1.domain_warp_fractal_lacunarity = 4.0
	noise1.domain_warp_fractal_gain = 0.35
	...
	noise2.frequency = 0.0071
	noise2.fractal_gain = 0.3
